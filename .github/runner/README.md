...
A containerized Actions runner for Flashlight CI/CD, with `uv` + `git` preinstalled.
...
|---|---|---|
| `GITHUB_URL` | `https://github.com/ychaparala/flashlight` | repo the runner joins |
| `RUNNER_NAME` | `flashlight-docker` | runner name shown in GitHub |
