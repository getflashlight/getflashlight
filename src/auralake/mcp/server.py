...
from auralake.transform.catalog import current_catalog, current_catalog_by_name
...
def query_metric(
    ...
    try:
        rows = query_view(name, limit=limit, order_by=order_by, descending=descending)
