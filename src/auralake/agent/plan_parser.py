...
from auralake.models.query_plans import PlanAntiPattern, PlanNode, SparkPlan
...
class PlanParser:
    ...
    ANTI_PATTERNS = [
        ...
        },
        {
            ...
            "severity": "high",
            "recommendation": "Add proper join conditions or use explicit broadcast hints for small tables.",
        },
        {
            ...
            "severity": "medium",
            "recommendation": "Check for data skew. Consider salting keys or broadcast join for smaller table.",
        },
        {
            ...
            "severity": "medium",
            "recommendation": "Consider repartitioning data or adjusting spark.sql.shuffle.partitions.",
        },
    ]
    ...
    def _detect_anti_patterns(self, plan_text: str) -> list[PlanAntiPattern]:
        ...
        for rule in self.ANTI_PATTERNS:
            ...
            if matches:
                patterns_found.append(PlanAntiPattern(
                    type=rule["type"],
