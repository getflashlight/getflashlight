...
from auralake.agent.scheduler import Scheduler
...
class Collector:
    ...
    def start(self) -> None:
        ...
        # Initialize DB
        try:
            from auralake.db.engine import init_engine
    ...
    def _collect(self) -> None:
        ...
        try:
            ...
            logger.info("collection_run_completed",
                        queries=len(queries), plans=plans_collected)
    ...
    def _store_plan(self, query: dict, spark_plan) -> None:
        ...
        try:
            ...
            from auralake.db.models import QueryPlan
