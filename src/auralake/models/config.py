...
class ThresholdsConfig(BaseModel):
    cluster_rightsizing: ClusterRightsizingThresholds = Field(default_factory=ClusterRightsizingThresholds)
    ...
    delta_maintenance: DeltaMaintenanceThresholds = Field(default_factory=DeltaMaintenanceThresholds)
    job_consolidation: JobConsolidationThresholds = Field(default_factory=JobConsolidationThresholds)
