...
The waste-plane sibling of :mod:`auralake.lake.bronze`. Same kernel — purge the
...
:class:`~auralake.efficiency.model.EfficiencyRecord` rows. Re-running a window is
...
dedupe step (unlike BRONZE's ``collapse_duplicates``).
"""
...
from auralake.lake.metrics_schema import build_table
