...
The waste-plane sibling of :mod:`auralake.lake.schema`: a fixed :class:`pyarrow.Schema`
mirroring :class:`~auralake.efficiency.model.EfficiencyRecord`, plus the row/table
