...
from auralake.models.routing import DatabricksFeatureDependency, WorkloadProfile
    ...
    def analyze(self) -> AnalysisResult:
        ...
        for job in jobs:
            ...
            for feature in features_used:
                if feature in self.PROPRIETARY_FEATURES:
                    deps.append(DatabricksFeatureDependency(
                        feature=feature,
                        usage_count=1,
        ...
        return AnalysisResult(
            ...
            summary={
                ...
                "avg_portability_score": sum(p.portability_score for p in profiles) / len(profiles) if profiles else 0,
            },
        )
