...
class DeltaAnalyzer(AbstractAnalyzer):
    ...
    def analyze_table(self, table_name: str) -> list[Recommendation]:
        ...
        try:
            ...
            if avg_file_mb < thresholds.small_file_threshold_mb and size_gb >= thresholds.optimize_threshold_gb:
                recommendations.append(Recommendation(
                    ...
                    description=f"Table has {num_files} files averaging {avg_file_mb:.1f} MB. Consider running OPTIMIZE.",
                    current_state={"num_files": num_files, "avg_file_mb": avg_file_mb, "size_gb": size_gb},
