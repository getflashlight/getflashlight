    ...
    def analyze(self) -> AnalysisResult:
        ...
        for cluster in clusters:
            ...
            if estimated_savings_pct >= min_savings:
                monthly_savings = Decimal(str(util.total_cost_usd * 0.6)) if util.total_cost_usd else Decimal("200")
                recommendations.append(Recommendation(
                    ...
                    description=f"Cluster runs {cluster.num_workers} on-demand workers. Spot can save ~{estimated_savings_pct}%.",
