...
neither layer has it, the caller (``views/chat.py``) just leaves the field
...
_SERVICE = "flashlight-chat"
ENV_VAR = "FLASHLIGHT_CHAT_API_KEY"
...
def load_api_key(provider: str) -> str | None:
    ...
    try:
        ...
        stored = None
    return stored or os.environ.get(ENV_VAR) or None
