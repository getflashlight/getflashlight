...
Expected output:
```
Generating synthetic Snowflake ACCOUNT_USAGE data for ≤$600K/year demo account...
  Account: ACME_ANALYTICS
  Period: 2026-01-01 to 2026-08-08
  Monthly credits target: 12,000.0
  Annual cost target: $576,000
  Caps: ≤$50,000/mo · ≤$600,000/yr
```

(Row counts and waste dollar amounts scale with the credit budget; all cost
services from the reference $4.032M profile are retained.)
...
```python
ANNUAL_COST_TARGET = 576_000  # headroom under $50K/mo and $600K/yr caps
MONTHLY_CREDITS = ANNUAL_COST_TARGET / (12 * CREDIT_PRICE)  # 12,000 at $4/credit
```
