...
**Target Profile**: Enterprise account "ACME_ANALYTICS" with ~$3M/year Snowflake spend across ETL, BI, ML/AI, streaming, and development workloads.
...
|----------|----------|-----------|---------------------|
| Managed Compute (Warehouses) | 55% | $136K | warehouse_metering_history |
| AI & ML Services | 10% | $25K | metering_history (AI portion) |
| Serverless/Managed Services | 12% | $30K | metering_history (managed portion) |
| Storage | 13% | $33K | storage_usage × $23/TB/month |
| Cloud Services Overhead | 6% | $15K | credits_used_cloud_services |
| Data Transfer | 1% | $2.5K | data_transfer_history |
| Other (QAS, hybrid, etc.) | 3% | $7K | metering_daily_history |
...
| 3 | Attribution credits = MONTHLY_CREDITS | `query_attribution_history.credits_attributed_compute.sum() == 84000` |
...
| 7 | Storage ~13% of TCO | ~$33K storage / ~$248K total monthly |
